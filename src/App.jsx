...
export default function App() {
  ...
  React.useEffect(() => { currentNote && setTempNoteText(currentNote.body) }, [currentNote])

  React.useEffect(() => {
    const timeoutId = setTimeout(() => { tempNoteText !== currentNote?.body && updateNote(tempNoteText) }, 500)
